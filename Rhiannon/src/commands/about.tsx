...
export default function about(): CommandHandler<Env> {
  ...
  return async () => <Message ephemeral>
    <Embed
      title={"Hello, My Name is Vanguard!"}
      color={1598208}
    ...
    >
      ...
      <Field name="Github:" inline>https://github.com/cloudflare-community/vanguard</Field>
      <Field name="Report Issue:" inline>https://github.com/cloudflare-community/vanguard/issues</Field>
    </Embed>
  </Message>;
}